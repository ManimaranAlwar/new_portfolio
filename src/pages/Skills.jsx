...
function Skills() {
  const skills = [
    { name: 'Python', category: 'Programming', level: 90, iconName: 'FileCode2', color: '#3776ab' },
    { name: 'Java', category: 'Programming', level: 85, iconName: 'Coffee', color: '#f97316' },
    { name: 'C Programming', category: 'Programming', level: 82, iconName: 'Braces', color: '#60a5fa' },
    ...
    { name: 'HTML5', category: 'Frontend', level: 84, iconName: 'PanelsTopLeft', color: '#f97316' },
